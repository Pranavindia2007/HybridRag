"""
config.py
Central configuration for the SPI ASIC verification RAG system.
...
for d in (DATA_DIR, RAW_DOCS_DIR, VECTOR_STORE_DIR, GRAPH_STORE_DIR, CACHE_DIR):
...
# Document registry
# --------------------------------------------------------------------------
# Add one entry per spec. doc_id is the namespace used everywhere
# (chunk metadata, vector filters, graph fusion, citations).
DOCUMENT_REGISTRY = {
    "spi_spec_a": RAW_DOCS_DIR / "TB3157Serial-Peripheral-Interface-Communications-on-8-bit-PIC-90003157A.pdf",
    #"spi_spec_b": RAW_DOCS_DIR / "spi_spec_b.pdf",
}
...
class RetrievalConfig:
    ...
    rrf_k: int = 60
    # Fields/registers are exact-match sensitive (CPOL, CS#, 0x1A...) --
